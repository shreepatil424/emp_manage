          ...
          <ul class="navbar-nav">
           ...
           <!--  <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <a class="nav-link" href="<?php echo base_url('get_emp_profile/'.$emp_id);?>">
              ...
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  ...
                  <div class="media-body  ml-2  d-none d-lg-block">
                    ...
                    <!-- John Snow -->
                     <?php echo $fname = $this->session->userdata('fname');?>
                    </span>
                  </div>
                </div>
              </a>
              <div class="dropdown-menu  dropdown-menu-right ">
                <div class="dropdown-header noti-title">
                  <h6 class="text-overflow m-0">
                    <!-- Welcome! --> <?php echo $designation = $this->session->userdata('designation');?>
                  </h6>
                </div>
              <?php $emp_id = $this->session->userdata('emp_id');?>
              <a href="<?php echo base_url('get_emp_profile/'.$emp_id);?>" class="dropdown-item">
